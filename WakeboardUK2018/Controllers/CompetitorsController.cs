    ...
    public class CompetitorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var competitor = await _context.Competitors
                .SingleOrDefaultAsync(m => m.CompetitorId == id);
            if (competitor == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("CompetitorId,Firstname,Surname,Url,CreateDate,ImageUrl,SexId,CountryId")] Competitor competitor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompetitorId,Firstname,Surname,Url,CreateDate,ImageUrl,SexId,CountryId")] Competitor competitor)
        {
