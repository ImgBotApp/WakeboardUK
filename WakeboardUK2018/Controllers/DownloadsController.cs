    ...
    public class DownloadsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var download = await _context.Downloads
                .SingleOrDefaultAsync(m => m.DownloadId == id);
            if (download == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("DownloadId,Name,Description,Url")] Download download)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DownloadId,Name,Description,Url")] Download download)
        {
